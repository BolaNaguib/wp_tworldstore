...
{
    ob_start();
    echo '<div class="next-button bg-white inline-block text-main hover:text-secondary transition duration-300 ease-in-out  fixed bottom-0 left-0 m-6 z-10">';
...
{
    ob_start();
    echo '<div class="previous-button bg-white  inline-block text-main hover:text-secondary transition duration-300 ease-in-out  fixed bottom-0 right-0 m-6 z-10">';
    // 'product_cat' will make sure to return next/prev from current category
