...
<html lang="en">
	...
	<body
	<?php body_class('font-body tracking-wide bodyx overflow-x-hidden'); ?>
		...
		<div class="container mx-auto px-6">
			<div class="lg:hidden">
				<div class="text-center">
					<span class="text-white mr-2 text-sm">
						<?php echo $header_custom_text ?>
					</span>
				</div>
					...
					<ul class="flex content-center justify-end">
						...
						<li>
							<a href="<?php echo $fb; ?>" class="text-white px-2 py-2 block">
								<svg
									style="max-height: 20px; min-height: 20px; height: 100%"
									aria-hidden="true"
									focusable="false"
									data-prefix="fab"
						...
						<li class="relative">
							<a
								href="<?php home_url() ?>/wishlist"
								class="text-white px-2 py-2 block"
								><svg
									style="max-height: 20px; min-height: 20px; height: 100%"
									aria-hidden="true"
									focusable="false"
									...
									xmlns="http://www.w3.org/2000/svg"
									viewBox="0 0 496 512"
									class="svg-inline--fa fa-grin-hearts fa-w-16"
								>
									<path
										fill="currentColor"
								...
								<!-- <span class="absolute bottom-0 right-0  bg-secondary text-xs w-4 h-4 text-center rounded-full mb-2">  
						...
						<li>
							...
							<a href="<?php echo $url; ?>my-account" class="
							<?php else : ?>
							<a
								href="#"
								class="modal-open <?php endif; ?> text-white px-2 py-2 block"
								><svg
									style="max-height: 20px; min-height: 20px; height: 100%"
									aria-hidden="true"
									focusable="false"
						...
						<li class="relative cartContainerx">
							<a href="#" class="text-white px-2 py-2 block relative"
								><svg
									style="max-height: 20px; min-height: 20px; height: 100%"
									aria-hidden="true"
									focusable="false"
								...
								<span
									class="absolute bottom-0 right-0 bg-secondary text-xs w-4 h-4 text-center rounded-full mb-2"
								>
									<?php echo $woocommerce->cart->cart_contents_count ?></span
								></a
							>
							<div
								class="cartContainer absolute text-left right-0 z-50 bg-white top-0 mt-8 shadow border-md p-2 rounded"
								style="width: 250px"
							>
	...
	<div class="bg-white">
		<div class="container mx-auto">
			<nav class="flex items-center bg-white px-3 flex-wrap justify-between">
				...
				<div>
					<div class="flex justify-between px-3">
						<div>
							<button
								id="mainmenu"
								class="text-white bg-main inline-flex p-3 hover:bg-gray-900 rounded lg:hidden mx-auto hover:text-white outline-none nav-toggler"
							>
							...
							>
								<ul
									class="lg:inline-flex lg:flex-row lg:mx-auto lg:w-auto w-full lg:items-center items-start flex flex-col lg:h-auto divide-x divide-gray-200"
								>
									...
									<li class="hoverable">
										<a
											...
											class="text-xl lg:inline-flex lg:w-auto w-full px-4 py-10 text-main items-center justify-center hover:bg-main hover:text-white transition duration-300 ease-in-out text-xs"
										>
										...
										<div class="p-6 mega-menu mb-16 sm:mb-0 shadow-xl bg-main">
											<div
												class="container mx-auto w-full flex flex-wrap justify-between mx-2 divide-x divide-white"
											>
												...
												<ul
													class="px-4 w-full sm:w-1/2 lg:w-1/4 border-b sm:border-r lg:border-b-0 pb-6 pt-6 lg:pt-3"
												>
													<?php 
                                                    if($term ) : ?>
													<div class="flex items-center">
														...
														>
															<a
																href="<?php echo esc_url(get_term_link($term[0])); ?>"
															>
                                                    ...
                                                    if ($postx) : ?>
														...
														<li>
															<a
																href="<?php echo esc_url(get_term_link($post)); ?>"
				...
				>
					<div
						class="w-auto h-10 pl-3 pr-2 bg-white border rounded-full flex justify-between items-center relative"
					>
						<input
	...
	<div class="rounded-lg shadow-md">
		...
		>
			<div class="px-5 pt-4 flex items-center justify-between">
				...
				<div class="-mr-2">
					<button
						id="menuCloseButton"
						type="button"
						class="main-menu inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:text-gray-500 transition duration-150 ease-in-out"
			...
			<ul class="px-2 pt-2 pb-3">
				...
				<li>
					<a
						class="block font-semibold px-3 py-2 text-gray-700 hover:text-white hover:bg-main transition duration-300 ease-in-out px-2"
						href="<?php echo $page_link; ?>""
