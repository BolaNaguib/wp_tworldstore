        ...
        <div class="container mx-auto px-6">
           ...
           <ul class="flex content-center justify-end">
                        ...
                        <li class="relative">
                            ...
                            <a href="<?php home_url() ?>/wishlist" class="text-white px-2 py-2 block"><svg style="max-height:20px; min-height:20px; height: 100%;" aria-hidden="true" focusable="false" data-prefix="far" data-icon="grin-hearts" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" class="svg-inline--fa fa-grin-hearts fa-w-16">
                                ...
                                <?php echo do_shortcode('[ti_wishlist_products_counter]') ?></span>
                            </a>
                        </li>
                        <li>
